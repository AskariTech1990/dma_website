...
const IntermediateFrames = () => {
  ...
  useEffect(() => {
    const fetchHframe = async () => {
      try {
        const category = "transportation"; // Define the category directly
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-4xl font-bold mb-8 text-center">Transportation</h1>
...
export default IntermediateFrames;
