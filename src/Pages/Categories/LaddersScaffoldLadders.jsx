...
const LaddersScaffoldLadders = () => {
  ...
  useEffect(() => {
    const fetchHframe = async () => {
      try {
        const category = "heavyEquipment"; // Define the category directly
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-4xl font-bold mb-8 text-center">Heavy Equipments</h1>
...
export default LaddersScaffoldLadders;
